...
const Signup = () => {
  ...
  const [createUserWithEmailAndPassword, loading, hookerror] = useCreateUserWithEmailAndPassword(auth, {
  ...
  useEffect(() => {
    if (user) {
      fetch("https://stormy-tor-21986.herokuapp.com/login", {
        method: "POST",
        headers: {
              ...
              <div className="col-lg-6 mx-auto">
                <div className="login-wrap">
                  ...
                  <form action="#" onSubmit={handleFormsubmit} className="login-form">
                    ...
                    <button type="submit" className="btn-special mb-2">
                      Sign Up
                    </button>
                    {hookerror ? (
                      <>
                    ...
                    <div className="text-center d-flex align-items-center flex-column">
                      <h5>Or</h5>
                      <GoogleButton onClick={handleGoogleButton} className="mb-3" />
                    </div>
                  </form>
                </div>
              </div>
